...
if [ ! -z $URL ]
then
wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/opus/opus-1.1.3.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/opus/opus-1.1.3.tar.gz || wget -nc http://downloads.xiph.org/releases/opus/opus-1.1.3.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/opus/opus-1.1.3.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/opus/opus-1.1.3.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/opus/opus-1.1.3.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/opus/opus-1.1.3.tar.gz
