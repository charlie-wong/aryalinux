...
if [ ! -z $URL ]
then
wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/dovecot/dovecot-2.2.25.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/dovecot/dovecot-2.2.25.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/dovecot/dovecot-2.2.25.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/dovecot/dovecot-2.2.25.tar.gz || wget -nc http://www.dovecot.org/releases/2.2/dovecot-2.2.25.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/dovecot/dovecot-2.2.25.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/dovecot/dovecot-2.2.25.tar.gz
