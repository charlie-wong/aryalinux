...
if [ ! -z $URL ]
then
wget -nc http://ftp.gnome.org/pub/gnome/sources/gmime/2.6/gmime-2.6.20.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/gmime/gmime-2.6.20.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/gmime/gmime-2.6.20.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/gmime/gmime-2.6.20.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/gmime/gmime-2.6.20.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/gmime/gmime-2.6.20.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/gmime/gmime-2.6.20.tar.xz || wget -nc ftp://ftp.gnome.org/pub/gnome/sources/gmime/2.6/gmime-2.6.20.tar.xz
