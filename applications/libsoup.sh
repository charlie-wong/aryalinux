...
if [ ! -z $URL ]
then
wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/libsoup/libsoup-2.56.0.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/libsoup/libsoup-2.56.0.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/libsoup/libsoup-2.56.0.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/libsoup/libsoup-2.56.0.tar.xz || wget -nc ftp://ftp.gnome.org/pub/gnome/sources/libsoup/2.56/libsoup-2.56.0.tar.xz || wget -nc http://ftp.gnome.org/pub/gnome/sources/libsoup/2.56/libsoup-2.56.0.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/libsoup/libsoup-2.56.0.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/libsoup/libsoup-2.56.0.tar.xz
