...
if [ ! -z $URL ]
then
wget -nc https://github.com/LMDB/lmdb/archive/LMDB_0.9.19.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/lmdb/LMDB_0.9.19.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/lmdb/LMDB_0.9.19.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/lmdb/LMDB_0.9.19.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/lmdb/LMDB_0.9.19.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/lmdb/LMDB_0.9.19.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/lmdb/LMDB_0.9.19.tar.gz
