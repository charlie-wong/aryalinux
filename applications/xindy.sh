...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.0/xindy-2.5.1-upstream_fixes-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/xindy/xindy-2.5.1-upstream_fixes-1.patch
