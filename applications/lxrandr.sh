...
if [ ! -z $URL ]
then
wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/lxrandr/lxrandr-0.3.1.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/lxrandr/lxrandr-0.3.1.tar.xz || wget -nc http://downloads.sourceforge.net/lxde/lxrandr-0.3.1.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/lxrandr/lxrandr-0.3.1.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/lxrandr/lxrandr-0.3.1.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/lxrandr/lxrandr-0.3.1.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/lxrandr/lxrandr-0.3.1.tar.xz
