...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.0/net-tools-CVS_20101030-remove_dups-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/net-tools/net-tools-CVS_20101030-remove_dups-1.patch || wget -nc https://raw.githubusercontent.com/FluidIdeas/patches/2016.11/net-tools-CVS_20101030-remove_dups-1.patch
