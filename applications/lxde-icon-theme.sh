...
if [ ! -z $URL ]
then
wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/lxde-icon-theme/lxde-icon-theme-0.5.1.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/lxde-icon-theme/lxde-icon-theme-0.5.1.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/lxde-icon-theme/lxde-icon-theme-0.5.1.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/lxde-icon-theme/lxde-icon-theme-0.5.1.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/lxde-icon-theme/lxde-icon-theme-0.5.1.tar.xz || wget -nc http://downloads.sourceforge.net/lxde/lxde-icon-theme-0.5.1.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/lxde-icon-theme/lxde-icon-theme-0.5.1.tar.xz
