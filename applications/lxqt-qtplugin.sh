...
if [ ! -z $URL ]
then
wget -nc https://github.com/lxde/lxqt-qtplugin/releases/download/0.11.1/lxqt-qtplugin-0.11.1.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/lxqt-qtplugin/lxqt-qtplugin-0.11.1.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/lxqt-qtplugin/lxqt-qtplugin-0.11.1.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/lxqt-qtplugin/lxqt-qtplugin-0.11.1.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/lxqt-qtplugin/lxqt-qtplugin-0.11.1.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/lxqt-qtplugin/lxqt-qtplugin-0.11.1.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/lxqt-qtplugin/lxqt-qtplugin-0.11.1.tar.xz
