...
if [ ! -z $URL ]
then
wget -nc http://ftp.gnome.org/pub/gnome/sources/epiphany/3.22/epiphany-3.22.6.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/epiphany/epiphany-3.22.6.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/epiphany/epiphany-3.22.6.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/epiphany/epiphany-3.22.6.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/epiphany/epiphany-3.22.6.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/epiphany/epiphany-3.22.6.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/epiphany/epiphany-3.22.6.tar.xz || wget -nc ftp://ftp.gnome.org/pub/gnome/sources/epiphany/3.22/epiphany-3.22.6.tar.xz
