...
if [ ! -z $URL ]
then
wget -nc http://www.apache.org/dist/subversion/subversion-1.9.4.tar.bz2 || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/subversion/subversion-1.9.4.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/subversion/subversion-1.9.4.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/subversion/subversion-1.9.4.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/subversion/subversion-1.9.4.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/subversion/subversion-1.9.4.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/subversion/subversion-1.9.4.tar.bz2
