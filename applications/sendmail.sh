...
if [ ! -z $URL ]
then
wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/sendmail/sendmail.8.15.2.tar.gz || wget -nc ftp://ftp.sendmail.org/pub/sendmail/sendmail.8.15.2.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/sendmail/sendmail.8.15.2.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/sendmail/sendmail.8.15.2.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/sendmail/sendmail.8.15.2.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/sendmail/sendmail.8.15.2.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/sendmail/sendmail.8.15.2.tar.gz
