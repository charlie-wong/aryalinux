...
if [ ! -z $URL ]
then
wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/traceroute/traceroute-2.1.0.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/traceroute/traceroute-2.1.0.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/traceroute/traceroute-2.1.0.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/traceroute/traceroute-2.1.0.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/traceroute/traceroute-2.1.0.tar.gz || wget -nc http://downloads.sourceforge.net/traceroute/traceroute-2.1.0.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/traceroute/traceroute-2.1.0.tar.gz
