...
if [ ! -z $URL ]
then
wget -nc http://www.ivmaisoft.com/_bin/atomic_ops/libatomic_ops-7.4.4.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/libatomic/libatomic_ops-7.4.4.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/libatomic/libatomic_ops-7.4.4.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/libatomic/libatomic_ops-7.4.4.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/libatomic/libatomic_ops-7.4.4.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/libatomic/libatomic_ops-7.4.4.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/libatomic/libatomic_ops-7.4.4.tar.gz
