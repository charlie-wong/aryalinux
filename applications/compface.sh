...
if [ ! -z $URL ]
then
wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/compface/compface-1.5.2.tar.gz || wget -nc ftp://anduin.linuxfromscratch.org/BLFS/compface/compface-1.5.2.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/compface/compface-1.5.2.tar.gz || wget -nc http://anduin.linuxfromscratch.org/BLFS/compface/compface-1.5.2.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/compface/compface-1.5.2.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/compface/compface-1.5.2.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/compface/compface-1.5.2.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/compface/compface-1.5.2.tar.gz
