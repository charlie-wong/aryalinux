...
if [ ! -z $URL ]
then
wget -nc http://downloads.sourceforge.net/xine/xine-ui-0.99.9.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/xine-ui/xine-ui-0.99.9.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/xine-ui/xine-ui-0.99.9.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/xine-ui/xine-ui-0.99.9.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/xine-ui/xine-ui-0.99.9.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/xine-ui/xine-ui-0.99.9.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/xine-ui/xine-ui-0.99.9.tar.xz
