...
if [ ! -z $URL ]
then
wget -nc http://www.zsh.org/pub/zsh-5.2.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/zsh/zsh-5.2.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/zsh/zsh-5.2.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/zsh/zsh-5.2.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/zsh/zsh-5.2.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/zsh/zsh-5.2.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/zsh/zsh-5.2.tar.xz
wget -nc http://www.zsh.org/pub/zsh-5.2-doc.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/zsh/zsh-5.2-doc.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/zsh/zsh-5.2-doc.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/zsh/zsh-5.2-doc.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/zsh/zsh-5.2-doc.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/zsh/zsh-5.2-doc.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/zsh/zsh-5.2-doc.tar.xz
