...
if [ ! -z $URL ]
then
wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/wireshark/wireshark-2.2.1.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/wireshark/wireshark-2.2.1.tar.bz2 || wget -nc https://www.wireshark.org/download/src/all-versions/wireshark-2.2.1.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/wireshark/wireshark-2.2.1.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/wireshark/wireshark-2.2.1.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/wireshark/wireshark-2.2.1.tar.bz2 || wget -nc ftp://ftp.uni-kl.de/pub/wireshark/src/wireshark-2.2.1.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/wireshark/wireshark-2.2.1.tar.bz2
