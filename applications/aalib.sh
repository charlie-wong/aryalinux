...
if [ ! -z $URL ]
then
wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/aalib/aalib-1.4rc5.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/aalib/aalib-1.4rc5.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/aalib/aalib-1.4rc5.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/aalib/aalib-1.4rc5.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/aalib/aalib-1.4rc5.tar.gz || wget -nc http://downloads.sourceforge.net/aa-project/aalib-1.4rc5.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/aalib/aalib-1.4rc5.tar.gz
