...
if [ ! -z $URL ]
then
wget -nc http://downloads.sourceforge.net/swig/swig-3.0.12.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/swig/swig-3.0.12.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/swig/swig-3.0.12.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/swig/swig-3.0.12.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/swig/swig-3.0.12.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/swig/swig-3.0.12.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/swig/swig-3.0.12.tar.gz
