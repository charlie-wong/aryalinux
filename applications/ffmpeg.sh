...
URL=http://ffmpeg.org/releases/ffmpeg-3.2.4.tar.xz

if [ ! -z $URL ]
then
wget -nc http://ffmpeg.org/releases/ffmpeg-3.2.4.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/ffmpeg/ffmpeg-3.2.4.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/ffmpeg/ffmpeg-3.2.4.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/ffmpeg/ffmpeg-3.2.4.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/ffmpeg/ffmpeg-3.2.4.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/ffmpeg/ffmpeg-3.2.4.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/ffmpeg/ffmpeg-3.2.4.tar.xz
