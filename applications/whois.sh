...
if [ ! -z $URL ]
then
wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/whois/whois_5.2.12.tar.xz || wget -nc http://ftp.debian.org/debian/pool/main/w/whois/whois_5.2.12.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/whois/whois_5.2.12.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/whois/whois_5.2.12.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/whois/whois_5.2.12.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/whois/whois_5.2.12.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/whois/whois_5.2.12.tar.xz || wget -nc ftp://ftp.debian.org/debian/pool/main/w/whois/whois_5.2.12.tar.xz
