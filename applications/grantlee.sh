...
if [ ! -z $URL ]
then
wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/grantlee/grantlee-5.1.0.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/grantlee/grantlee-5.1.0.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/grantlee/grantlee-5.1.0.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/grantlee/grantlee-5.1.0.tar.gz || wget -nc http://downloads.grantlee.org/grantlee-5.1.0.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/grantlee/grantlee-5.1.0.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/grantlee/grantlee-5.1.0.tar.gz
