...
if [ ! -z $URL ]
then
wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/libnfsidmap/libnfsidmap-0.26.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/libnfsidmap/libnfsidmap-0.26.tar.bz2 || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/libnfsidmap/libnfsidmap-0.26.tar.bz2 || wget -nc https://fedorapeople.org/~steved/libnfsidmap/0.26/libnfsidmap-0.26.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/libnfsidmap/libnfsidmap-0.26.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/libnfsidmap/libnfsidmap-0.26.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/libnfsidmap/libnfsidmap-0.26.tar.bz2
