...
if [ ! -z $URL ]
then
wget -nc http://downloads.lxqt.org/libsysstat/0.3.3/libsysstat-0.3.3.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/libsysstat/libsysstat-0.3.3.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/libsysstat/libsysstat-0.3.3.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/libsysstat/libsysstat-0.3.3.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/libsysstat/libsysstat-0.3.3.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/libsysstat/libsysstat-0.3.3.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/libsysstat/libsysstat-0.3.3.tar.xz
