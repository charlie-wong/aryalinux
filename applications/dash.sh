...
if [ ! -z $URL ]
then
wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/dash/dash-0.5.9.1.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/dash/dash-0.5.9.1.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/dash/dash-0.5.9.1.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/dash/dash-0.5.9.1.tar.gz || wget -nc http://gondor.apana.org.au/~herbert/dash/files/dash-0.5.9.1.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/dash/dash-0.5.9.1.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/dash/dash-0.5.9.1.tar.gz
