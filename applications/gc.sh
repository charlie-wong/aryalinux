...
if [ ! -z $URL ]
then
wget -nc http://www.hboehm.info/gc/gc_source/gc-7.6.0.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/gc/gc-7.6.0.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/gc/gc-7.6.0.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/gc/gc-7.6.0.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/gc/gc-7.6.0.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/gc/gc-7.6.0.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/gc/gc-7.6.0.tar.gz
