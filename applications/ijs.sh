...
if [ ! -z $URL ]
then
wget -nc https://www.openprinting.org/download/ijs/download/ijs-0.35.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/ijs/ijs-0.35.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/ijs/ijs-0.35.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/ijs/ijs-0.35.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/ijs/ijs-0.35.tar.bz2 || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/ijs/ijs-0.35.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/ijs/ijs-0.35.tar.bz2
