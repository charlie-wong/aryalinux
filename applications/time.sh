...
if [ ! -z $URL ]
then
wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/time/time-1.7.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/time/time-1.7.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/time/time-1.7.tar.gz || wget -nc ftp://ftp.gnu.org/gnu/time/time-1.7.tar.gz || wget -nc http://ftp.gnu.org/gnu/time/time-1.7.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/time/time-1.7.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/time/time-1.7.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/time/time-1.7.tar.gz
