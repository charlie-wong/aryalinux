...
if [ ! -z $URL ]
then
wget -nc http://archive.xfce.org/src/xfce/exo/0.10/exo-0.10.7.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/exo/exo-0.10.7.tar.bz2 || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/exo/exo-0.10.7.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/exo/exo-0.10.7.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/exo/exo-0.10.7.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/exo/exo-0.10.7.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/exo/exo-0.10.7.tar.bz2
