...
if [ ! -z $URL ]
then
wget -nc http://ftp.gnu.org/gnu/enscript/enscript-1.6.6.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/enscript/enscript-1.6.6.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/enscript/enscript-1.6.6.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/enscript/enscript-1.6.6.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/enscript/enscript-1.6.6.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/enscript/enscript-1.6.6.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/enscript/enscript-1.6.6.tar.gz || wget -nc ftp://mirror.ovh.net/gentoo-distfiles/distfiles/enscript-1.6.6.tar.gz
