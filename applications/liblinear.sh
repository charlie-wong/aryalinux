...
URL=https://github.com/cjlin1/liblinear/archive/v211.tar.gz

if [ ! -z $URL ]
then
wget -nc https://github.com/cjlin1/liblinear/archive/v211.tar.gz
...
wget -c https://github.com/cjlin1/liblinear/archive/v211.tar.gz \
     -O liblinear-211.tar.gz
