...
if [ ! -z $URL ]
then
wget -nc https://github.com/libfuse/sshfs/releases/download/sshfs_2.8/sshfs-2.8.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/sshfs/sshfs-2.8.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/sshfs/sshfs-2.8.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/sshfs/sshfs-2.8.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/sshfs/sshfs-2.8.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/sshfs/sshfs-2.8.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/sshfs/sshfs-2.8.tar.gz
