...
if [ ! -z $URL ]
then
wget -nc http://downloads.lxqt.org/lxqt/0.11.1/lxqt-globalkeys-0.11.1.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/lxqt-globalkeys/lxqt-globalkeys-0.11.1.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/lxqt-globalkeys/lxqt-globalkeys-0.11.1.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/lxqt-globalkeys/lxqt-globalkeys-0.11.1.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/lxqt-globalkeys/lxqt-globalkeys-0.11.1.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/lxqt-globalkeys/lxqt-globalkeys-0.11.1.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/lxqt-globalkeys/lxqt-globalkeys-0.11.1.tar.xz
