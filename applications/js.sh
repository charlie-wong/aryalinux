...
if [ ! -z $URL ]
then
wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/mozjs/mozjs17.0.0.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/mozjs/mozjs17.0.0.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/mozjs/mozjs17.0.0.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/mozjs/mozjs17.0.0.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/mozjs/mozjs17.0.0.tar.gz || wget -nc http://ftp.mozilla.org/pub/mozilla.org/js/mozjs17.0.0.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/mozjs/mozjs17.0.0.tar.gz
