...
if [ ! -z $URL ]
then
wget -nc ftp://ftp.proftpd.org/distrib/source/proftpd-1.3.5d.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/proftpd/proftpd-1.3.5d.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/proftpd/proftpd-1.3.5d.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/proftpd/proftpd-1.3.5d.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/proftpd/proftpd-1.3.5d.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/proftpd/proftpd-1.3.5d.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/proftpd/proftpd-1.3.5d.tar.gz
