...
if [ ! -z $URL ]
then
wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/gsl/gsl-2.2.1.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/gsl/gsl-2.2.1.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/gsl/gsl-2.2.1.tar.gz || wget -nc ftp://ftp.gnu.org/pub/gnu/gsl/gsl-2.2.1.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/gsl/gsl-2.2.1.tar.gz || wget -nc http://ftp.gnu.org/pub/gnu/gsl/gsl-2.2.1.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/gsl/gsl-2.2.1.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/gsl/gsl-2.2.1.tar.gz
