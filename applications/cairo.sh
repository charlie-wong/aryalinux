...
if [ ! -z $URL ]
then
wget -nc http://cairographics.org/releases/cairo-1.14.8.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/cairo/cairo-1.14.8.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/cairo/cairo-1.14.8.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/cairo/cairo-1.14.8.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/cairo/cairo-1.14.8.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/cairo/cairo-1.14.8.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/cairo/cairo-1.14.8.tar.xz
