...
if [ ! -z $URL ]
then
wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/sawfish/sawfish_1.12.0.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/sawfish/sawfish_1.12.0.tar.xz || wget -nc http://download.tuxfamily.org/sawfish/sawfish_1.12.0.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/sawfish/sawfish_1.12.0.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/sawfish/sawfish_1.12.0.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/sawfish/sawfish_1.12.0.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/sawfish/sawfish_1.12.0.tar.xz
