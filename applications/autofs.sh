...
if [ ! -z $URL ]
then
wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/autofs/autofs-5.1.2.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/autofs/autofs-5.1.2.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/autofs/autofs-5.1.2.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/autofs/autofs-5.1.2.tar.xz || wget -nc http://www.kernel.org/pub/linux/daemons/autofs/v5/autofs-5.1.2.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/autofs/autofs-5.1.2.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/autofs/autofs-5.1.2.tar.xz
