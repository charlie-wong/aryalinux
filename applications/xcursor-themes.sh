...
if [ ! -z $URL ]
then
wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/xcursor-themes/xcursor-themes-1.0.4.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/xcursor-themes/xcursor-themes-1.0.4.tar.bz2 || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/xcursor-themes/xcursor-themes-1.0.4.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/xcursor-themes/xcursor-themes-1.0.4.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/xcursor-themes/xcursor-themes-1.0.4.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/xcursor-themes/xcursor-themes-1.0.4.tar.bz2 || wget -nc ftp://ftp.x.org/pub/individual/data/xcursor-themes-1.0.4.tar.bz2 || wget -nc https://www.x.org/pub/individual/data/xcursor-themes-1.0.4.tar.bz2
