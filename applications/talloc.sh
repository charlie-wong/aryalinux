...
if [ ! -z $URL ]
then
wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/talloc/talloc-2.1.8.tar.gz || wget -nc https://www.samba.org/ftp/talloc/talloc-2.1.8.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/talloc/talloc-2.1.8.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/talloc/talloc-2.1.8.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/talloc/talloc-2.1.8.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/talloc/talloc-2.1.8.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/talloc/talloc-2.1.8.tar.gz
