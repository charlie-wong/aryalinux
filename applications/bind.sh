...
wget -nc http://www.linuxfromscratch.org/patches/downloads/bind/bind-9.11.0-P3-use_iproute2-1.patch || wget -nc http://www.linuxfromscratch.org/patches/blfs/svn/bind-9.11.0-P3-use_iproute2-1.patch
