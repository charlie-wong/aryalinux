...
if [ ! -z $URL ]
then
wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/pango/pango-1.40.3.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/pango/pango-1.40.3.tar.xz || wget -nc http://ftp.gnome.org/pub/gnome/sources/pango/1.40/pango-1.40.3.tar.xz || wget -nc ftp://ftp.gnome.org/pub/gnome/sources/pango/1.40/pango-1.40.3.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/pango/pango-1.40.3.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/pango/pango-1.40.3.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/pango/pango-1.40.3.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/pango/pango-1.40.3.tar.xz
