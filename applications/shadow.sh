...
if [ ! -z $URL ]
then
wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/shadow/shadow-4.4.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/shadow/shadow-4.4.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/shadow/shadow-4.4.tar.xz || wget -nc https://github.com/shadow-maint/shadow/releases/download/4.4/shadow-4.4.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/shadow/shadow-4.4.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/shadow/shadow-4.4.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/shadow/shadow-4.4.tar.xz
