...
if [ ! -z $URL ]
then
wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/libcdio/libcdio-0.94.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/libcdio/libcdio-0.94.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/libcdio/libcdio-0.94.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/libcdio/libcdio-0.94.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/libcdio/libcdio-0.94.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/libcdio/libcdio-0.94.tar.gz || wget -nc http://ftp.gnu.org/gnu/libcdio/libcdio-0.94.tar.gz
wget -nc http://ftp.gnu.org/gnu/libcdio/libcdio-paranoia-10.2+0.94+1.tar.bz2 || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/libcdio/libcdio-paranoia-10.2+0.94+1.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/libcdio/libcdio-paranoia-10.2+0.94+1.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/libcdio/libcdio-paranoia-10.2+0.94+1.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/libcdio/libcdio-paranoia-10.2+0.94+1.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/libcdio/libcdio-paranoia-10.2+0.94+1.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/libcdio/libcdio-paranoia-10.2+0.94+1.tar.bz2
