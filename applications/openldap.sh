...
wget -nc http://www.linuxfromscratch.org/patches/downloads/openldap/openldap-2.4.44-consolidated-2.patch || wget -nc http://www.linuxfromscratch.org/patches/blfs/8.0/openldap-2.4.44-consolidated-2.patch
