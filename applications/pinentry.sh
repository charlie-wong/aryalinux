...
if [ ! -z $URL ]
then
wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/pinentry/pinentry-1.0.0.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/pinentry/pinentry-1.0.0.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/pinentry/pinentry-1.0.0.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/pinentry/pinentry-1.0.0.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/pinentry/pinentry-1.0.0.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/pinentry/pinentry-1.0.0.tar.bz2 || wget -nc ftp://ftp.gnupg.org/gcrypt/pinentry/pinentry-1.0.0.tar.bz2
