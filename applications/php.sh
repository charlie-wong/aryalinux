...
if [ ! -z $URL ]
then
wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/php/php-7.1.2.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/php/php-7.1.2.tar.xz || wget -nc http://www.php.net/distributions/php-7.1.2.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/php/php-7.1.2.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/php/php-7.1.2.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/php/php-7.1.2.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/php/php-7.1.2.tar.xz
