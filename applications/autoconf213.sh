...
if [ ! -z $URL ]
then
wget -nc http://ftp.gnu.org/gnu/autoconf/autoconf-2.13.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/autoconf/autoconf-2.13.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/autoconf/autoconf-2.13.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/autoconf/autoconf-2.13.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/autoconf/autoconf-2.13.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/autoconf/autoconf-2.13.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/autoconf/autoconf-2.13.tar.gz || wget -nc ftp://ftp.gnu.org/gnu/autoconf/autoconf-2.13.tar.gz
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.0/autoconf-2.13-consolidated_fixes-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/autoconf/autoconf-2.13-consolidated_fixes-1.patch
