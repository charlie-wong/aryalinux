...
if [ ! -z $URL ]
then
wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/mutt/mutt-1.7.2.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/mutt/mutt-1.7.2.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/mutt/mutt-1.7.2.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/mutt/mutt-1.7.2.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/mutt/mutt-1.7.2.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/mutt/mutt-1.7.2.tar.gz || wget -nc ftp://ftp.mutt.org/pub/mutt/mutt-1.7.2.tar.gz
