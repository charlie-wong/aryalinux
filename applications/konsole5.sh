...
if [ ! -z $URL ]
then
wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/konsole/konsole-16.08.0.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/konsole/konsole-16.08.0.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/konsole/konsole-16.08.0.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/konsole/konsole-16.08.0.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/konsole/konsole-16.08.0.tar.xz || wget -nc http://download.kde.org/stable/applications/16.08.0/src/konsole-16.08.0.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/konsole/konsole-16.08.0.tar.xz
