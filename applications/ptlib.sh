...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.0/ptlib-2.10.11-bison_fixes-2.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/ptlib/ptlib-2.10.11-bison_fixes-2.patch
