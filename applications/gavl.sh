...
if [ ! -z $URL ]
then
wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/gavl/gavl-1.4.0.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/gavl/gavl-1.4.0.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/gavl/gavl-1.4.0.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/gavl/gavl-1.4.0.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/gavl/gavl-1.4.0.tar.gz || wget -nc http://sourceforge.net/projects/gmerlin/files/gavl/1.4.0/gavl-1.4.0.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/gavl/gavl-1.4.0.tar.gz
