...
if [ ! -z $URL ]
then
wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/soundtouch/soundtouch-1.9.2.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/soundtouch/soundtouch-1.9.2.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/soundtouch/soundtouch-1.9.2.tar.gz || wget -nc http://www.surina.net/soundtouch/soundtouch-1.9.2.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/soundtouch/soundtouch-1.9.2.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/soundtouch/soundtouch-1.9.2.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/soundtouch/soundtouch-1.9.2.tar.gz
