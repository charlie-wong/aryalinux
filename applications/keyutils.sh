...
if [ ! -z $URL ]
then
wget -nc http://people.redhat.com/~dhowells/keyutils/keyutils-1.5.9.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/keyutils/keyutils-1.5.9.tar.bz2 || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/keyutils/keyutils-1.5.9.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/keyutils/keyutils-1.5.9.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/keyutils/keyutils-1.5.9.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/keyutils/keyutils-1.5.9.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/keyutils/keyutils-1.5.9.tar.bz2
