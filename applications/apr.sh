...
if [ ! -z $URL ]
then
wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/apr/apr-1.5.2.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/apr/apr-1.5.2.tar.bz2 || wget -nc http://archive.apache.org/dist/apr/apr-1.5.2.tar.bz2 || wget -nc ftp://ftp.mirrorservice.org/sites/ftp.apache.org/apr/apr-1.5.2.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/apr/apr-1.5.2.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/apr/apr-1.5.2.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/apr/apr-1.5.2.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/apr/apr-1.5.2.tar.bz2
