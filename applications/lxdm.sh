...
if [ ! -z $URL ]
then
wget -nc http://downloads.sourceforge.net/lxdm/lxdm-0.5.3.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/lxdm/lxdm-0.5.3.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/lxdm/lxdm-0.5.3.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/lxdm/lxdm-0.5.3.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/lxdm/lxdm-0.5.3.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/lxdm/lxdm-0.5.3.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/lxdm/lxdm-0.5.3.tar.xz
