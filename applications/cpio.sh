...
if [ ! -z $URL ]
then
wget -nc ftp://ftp.gnu.org/pub/gnu/cpio/cpio-2.12.tar.bz2 || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/cpio/cpio-2.12.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/cpio/cpio-2.12.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/cpio/cpio-2.12.tar.bz2 || wget -nc http://ftp.gnu.org/pub/gnu/cpio/cpio-2.12.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/cpio/cpio-2.12.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/cpio/cpio-2.12.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/cpio/cpio-2.12.tar.bz2
