...
if [ ! -z $URL ]
then
wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/dvd+rw-tools/dvd+rw-tools-7.1.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/dvd+rw-tools/dvd+rw-tools-7.1.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/dvd+rw-tools/dvd+rw-tools-7.1.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/dvd+rw-tools/dvd+rw-tools-7.1.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/dvd+rw-tools/dvd+rw-tools-7.1.tar.gz || wget -nc http://fy.chalmers.se/~appro/linux/DVD+RW/tools/dvd+rw-tools-7.1.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/dvd+rw-tools/dvd+rw-tools-7.1.tar.gz
