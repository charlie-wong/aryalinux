...
if [ ! -z $URL ]
then
wget -nc http://downloads.lxqt.org/libqtxdg/2.0.0/libqtxdg-2.0.0.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/libqtxdg/libqtxdg-2.0.0.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/libqtxdg/libqtxdg-2.0.0.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/libqtxdg/libqtxdg-2.0.0.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/libqtxdg/libqtxdg-2.0.0.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/libqtxdg/libqtxdg-2.0.0.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/libqtxdg/libqtxdg-2.0.0.tar.xz
