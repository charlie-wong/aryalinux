...
if [ ! -z $URL ]
then
wget -nc http://archive.xfce.org/src/xfce/xfdesktop/4.12/xfdesktop-4.12.3.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/xfdesktop/xfdesktop-4.12.3.tar.bz2 || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/xfdesktop/xfdesktop-4.12.3.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/xfdesktop/xfdesktop-4.12.3.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/xfdesktop/xfdesktop-4.12.3.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/xfdesktop/xfdesktop-4.12.3.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/xfdesktop/xfdesktop-4.12.3.tar.bz2
