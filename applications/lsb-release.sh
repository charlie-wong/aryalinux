...
if [ ! -z $URL ]
then
wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/lsb-release/lsb-release-1.4.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/lsb-release/lsb-release-1.4.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/lsb-release/lsb-release-1.4.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/lsb-release/lsb-release-1.4.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/lsb-release/lsb-release-1.4.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/lsb-release/lsb-release-1.4.tar.gz || wget -nc http://sourceforge.net/projects/lsb/files/lsb_release/1.4/lsb-release-1.4.tar.gz
