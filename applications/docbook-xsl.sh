...
if [ ! -z $URL ]
then
wget -nc http://downloads.sourceforge.net/docbook/docbook-xsl-1.79.1.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/docbook-xsl/docbook-xsl-1.79.1.tar.bz2 || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/docbook-xsl/docbook-xsl-1.79.1.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/docbook-xsl/docbook-xsl-1.79.1.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/docbook-xsl/docbook-xsl-1.79.1.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/docbook-xsl/docbook-xsl-1.79.1.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/docbook-xsl/docbook-xsl-1.79.1.tar.bz2
wget -nc http://downloads.sourceforge.net/docbook/docbook-xsl-doc-1.79.1.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/docbook-xsl-doc/docbook-xsl-doc-1.79.1.tar.bz2 || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/docbook-xsl-doc/docbook-xsl-doc-1.79.1.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/docbook-xsl-doc/docbook-xsl-doc-1.79.1.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/docbook-xsl-doc/docbook-xsl-doc-1.79.1.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/docbook-xsl-doc/docbook-xsl-doc-1.79.1.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/docbook-xsl-doc/docbook-xsl-doc-1.79.1.tar.bz2
