...
if [ ! -z $URL ]
then
wget -nc http://downloads.us.xiph.org/releases/speex/speex-1.2rc2.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/speex/speex-1.2rc2.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/speex/speex-1.2rc2.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/speex/speex-1.2rc2.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/speex/speex-1.2rc2.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/speex/speex-1.2rc2.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/speex/speex-1.2rc2.tar.gz
