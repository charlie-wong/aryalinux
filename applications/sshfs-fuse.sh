...
if [ ! -z $URL ]
then
wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/sshfs-fuse/sshfs-fuse-2.5.tar.gz || wget -nc https://github.com/libfuse/sshfs/releases/download/sshfs_2_5/sshfs-fuse-2.5.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/sshfs-fuse/sshfs-fuse-2.5.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/sshfs-fuse/sshfs-fuse-2.5.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/sshfs-fuse/sshfs-fuse-2.5.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/sshfs-fuse/sshfs-fuse-2.5.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/sshfs-fuse/sshfs-fuse-2.5.tar.gz
