...
if [ ! -z $URL ]
then
wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/rep-gtk/rep-gtk_0.90.8.3.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/rep-gtk/rep-gtk_0.90.8.3.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/rep-gtk/rep-gtk_0.90.8.3.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/rep-gtk/rep-gtk_0.90.8.3.tar.xz || wget -nc http://download.tuxfamily.org/librep/rep-gtk/rep-gtk_0.90.8.3.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/rep-gtk/rep-gtk_0.90.8.3.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/rep-gtk/rep-gtk_0.90.8.3.tar.xz
