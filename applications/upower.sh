...
if [ ! -z $URL ]
then
wget -nc http://upower.freedesktop.org/releases/upower-0.99.4.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/upower/upower-0.99.4.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/upower/upower-0.99.4.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/upower/upower-0.99.4.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/upower/upower-0.99.4.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/upower/upower-0.99.4.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/upower/upower-0.99.4.tar.xz
