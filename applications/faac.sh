...
if [ ! -z $URL ]
then
wget -nc http://downloads.sourceforge.net/faac/faac-1.28.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/faac/faac-1.28.tar.bz2 || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/faac/faac-1.28.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/faac/faac-1.28.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/faac/faac-1.28.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/faac/faac-1.28.tar.bz2 || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/faac/faac-1.28.tar.bz2
