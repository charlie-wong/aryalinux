...
wget -nc http://www.linuxfromscratch.org/patches/downloads/geoclue/geoclue-0.12.0-gpsd_fix-1.patch || wget -nc http://www.linuxfromscratch.org/patches/blfs/8.0/geoclue-0.12.0-gpsd_fix-1.patch
