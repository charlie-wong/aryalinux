...
if [ ! -z $URL ]
then
wget -nc http://ftp.gnome.org/pub/gnome/sources/libgweather/3.20/libgweather-3.20.4.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/libgweather/libgweather-3.20.4.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/libgweather/libgweather-3.20.4.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/libgweather/libgweather-3.20.4.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/libgweather/libgweather-3.20.4.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/libgweather/libgweather-3.20.4.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/libgweather/libgweather-3.20.4.tar.xz || wget -nc ftp://ftp.gnome.org/pub/gnome/sources/libgweather/3.20/libgweather-3.20.4.tar.xz
