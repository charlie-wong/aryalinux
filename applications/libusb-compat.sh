...
if [ ! -z $URL ]
then
wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/libusb/libusb-compat-0.1.5.tar.bz2 || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/libusb/libusb-compat-0.1.5.tar.bz2 || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/libusb/libusb-compat-0.1.5.tar.bz2 || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/libusb/libusb-compat-0.1.5.tar.bz2 || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/libusb/libusb-compat-0.1.5.tar.bz2 || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/libusb/libusb-compat-0.1.5.tar.bz2 || wget -nc http://downloads.sourceforge.net/libusb/libusb-compat-0.1.5.tar.bz2
