...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.0/abiword-3.0.2-gtk3_22_render_fix-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/abiword/abiword-3.0.2-gtk3_22_render_fix-1.patch
