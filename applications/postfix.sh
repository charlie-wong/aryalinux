...
URL=ftp://ftp.porcupine.org/mirrors/postfix-release/official/postfix-3.2.0.tar.gz

if [ ! -z $URL ]
then
wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/postfix/postfix-3.2.0.tar.gz || wget -nc ftp://ftp.porcupine.org/mirrors/postfix-release/official/postfix-3.2.0.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/postfix/postfix-3.2.0.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/postfix/postfix-3.2.0.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/postfix/postfix-3.2.0.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/postfix/postfix-3.2.0.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/postfix/postfix-3.2.0.tar.gz
