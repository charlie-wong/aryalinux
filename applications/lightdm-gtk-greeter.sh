...
wget -nc https://launchpad.net/lightdm-gtk-greeter/2.0/2.0.2/+download/lightdm-gtk-greeter-2.0.2.tar.gz


TARBALL=lightdm-gtk-greeter-2.0.2.tar.gz
DIRECTORY=lightdm-gtk-greeter-2.0.2
...
theme-name = Greybird
background = /usr/share/backgrounds/aryalinux/sunrise-phu-quoc-island-ocean.jpg
