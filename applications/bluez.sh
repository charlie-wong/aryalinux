...
if [ ! -z $URL ]
then
wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/bluez/bluez-5.43.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/bluez/bluez-5.43.tar.xz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/bluez/bluez-5.43.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/bluez/bluez-5.43.tar.xz || wget -nc http://www.kernel.org/pub/linux/bluetooth/bluez-5.43.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/bluez/bluez-5.43.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/bluez/bluez-5.43.tar.xz
