...
if [ ! -z $URL ]
then
wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/gnumeric/gnumeric-1.12.32.tar.xz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/gnumeric/gnumeric-1.12.32.tar.xz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/gnumeric/gnumeric-1.12.32.tar.xz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/gnumeric/gnumeric-1.12.32.tar.xz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/gnumeric/gnumeric-1.12.32.tar.xz || wget -nc http://ftp.gnome.org/pub/gnome/sources/gnumeric/1.12/gnumeric-1.12.32.tar.xz || wget -nc ftp://ftp.gnome.org/pub/gnome/sources/gnumeric/1.12/gnumeric-1.12.32.tar.xz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/gnumeric/gnumeric-1.12.32.tar.xz
