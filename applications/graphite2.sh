...
if [ ! -z $URL ]
then
wget -nc https://github.com/silnrsi/graphite/releases/download/1.3.9/graphite2-1.3.9.tgz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/graphite2/graphite2-1.3.9.tgz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/graphite2/graphite2-1.3.9.tgz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/graphite2/graphite2-1.3.9.tgz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/graphite2/graphite2-1.3.9.tgz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/graphite2/graphite2-1.3.9.tgz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/graphite2/graphite2-1.3.9.tgz
