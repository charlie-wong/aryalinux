...
if [ ! -z $URL ]
then
wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/exiv2/exiv2-0.25.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/exiv2/exiv2-0.25.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/exiv2/exiv2-0.25.tar.gz || wget -nc http://www.exiv2.org/exiv2-0.25.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/exiv2/exiv2-0.25.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/exiv2/exiv2-0.25.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/exiv2/exiv2-0.25.tar.gz
