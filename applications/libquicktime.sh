...
if [ ! -z $URL ]
then
wget -nc http://downloads.sourceforge.net/libquicktime/libquicktime-1.2.4.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/libquicktime/libquicktime-1.2.4.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/libquicktime/libquicktime-1.2.4.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/libquicktime/libquicktime-1.2.4.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/libquicktime/libquicktime-1.2.4.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/libquicktime/libquicktime-1.2.4.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/libquicktime/libquicktime-1.2.4.tar.gz
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.0/libquicktime-1.2.4-ffmpeg3-1.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/libquicktime/libquicktime-1.2.4-ffmpeg3-1.patch
