...
if [ ! -z $URL ]
then
wget -nc http://ftp.gnu.org/gnu/a2ps/a2ps-4.14.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/a2ps/a2ps-4.14.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/a2ps/a2ps-4.14.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/a2ps/a2ps-4.14.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/a2ps/a2ps-4.14.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/a2ps/a2ps-4.14.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/a2ps/a2ps-4.14.tar.gz || wget -nc ftp://ftp.gnu.org/gnu/a2ps/a2ps-4.14.tar.gz
