...
URL=ftp://ftp.stunnel.org/stunnel/archive/5.x/stunnel-5.40.tar.gz

if [ ! -z $URL ]
then
wget -nc ftp://ftp.stunnel.org/stunnel/archive/5.x/stunnel-5.40.tar.gz || wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/stunnel/stunnel-5.40.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/stunnel/stunnel-5.40.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/stunnel/stunnel-5.40.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/stunnel/stunnel-5.40.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/stunnel/stunnel-5.40.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/stunnel/stunnel-5.40.tar.gz
