...
URL=ftp://ftp.stunnel.org/stunnel/archive/5.x/stunnel-5.39.tar.gz

if [ ! -z $URL ]
then
wget -nc http://mirrors-usa.go-parts.com/blfs/conglomeration/stunnel/stunnel-5.39.tar.gz || wget -nc ftp://ftp.stunnel.org/stunnel/archive/5.x/stunnel-5.39.tar.gz || wget -nc ftp://ftp.lfs-matrix.net/pub/blfs/conglomeration/stunnel/stunnel-5.39.tar.gz || wget -nc http://mirrors-ru.go-parts.com/blfs/conglomeration/stunnel/stunnel-5.39.tar.gz || wget -nc ftp://ftp.osuosl.org/pub/blfs/conglomeration/stunnel/stunnel-5.39.tar.gz || wget -nc http://ftp.lfs-matrix.net/pub/blfs/conglomeration/stunnel/stunnel-5.39.tar.gz || wget -nc http://ftp.osuosl.org/pub/blfs/conglomeration/stunnel/stunnel-5.39.tar.gz
...
sudo tee rootscript.sh << "ENDOFROOTSCRIPT"
make docdir=/usr/share/doc/stunnel-5.39 install
