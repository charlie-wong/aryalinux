...
wget -nc http://www.linuxfromscratch.org/patches/blfs/8.0/epdfview-0.1.8-fixes-2.patch || wget -nc http://www.linuxfromscratch.org/patches/downloads/epdfview/epdfview-0.1.8-fixes-2.patch
